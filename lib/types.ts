export type Race = 'human' | 'elf' | 'tauren' | 'fox' | 'cat' | 'machine' | 'dragon' | 'succubus'
...
export const CHAT_MODELS: ChatModelInfo[] = [
  { value: 'x-apex-surge-0505-16k', label: 'Apex Surge 16K', group: 'DZMM', provider: 'default' },
...
export const RACE_INFO: Record<Race, { label: string; description: string; trait: string }> = {
  ...
  dragon: {
    label: '龙族',
    description: '高傲强韧、龙血滚烫——坚硬鳞甲寻常难破，可龙焰一旦被点燃，越是骄矜越沉沦。',
    trait: '巨龙血脉、高傲强韧：HP 与耐受极高，坚硬的鳞甲令寻常束缚与攻击难以奏效，睥睨众生的骄矜也令她被玷污时的屈辱与不甘格外浓烈；然而体内翻涌的龙焰（或寒霜之力）一旦被点燃，便会由内而外灼烧、瓦解她的理智，发情时龙角泛热、龙尾无措地摆动、下体滚烫泥泞，越是逞强便败得越彻底。适合高傲堕落、龙血发情、骄龙被驯服俯首、产卵孕育的描写。',
  },
  succubus: {
    label: '魅魔族',
    description: '天生淫体、以欲为食——媚惑是她的本能与力量，却也最易反被快感反噬吞没。',
    trait: '魅魔血脉、天生淫体：以性与欲望为食，媚惑本能与魔力与生俱来，肌肤、尾巴、翅膜与魔角皆是敏感带，欲望上涨极快、极易发情高潮且愈战愈勇。她惯于以色诱掌控猎物，可一旦被更强者压制、被自己引燃的快感反噬，便会从掠食者沦为被喂养、被反向榨取的雌性，落差极大。适合魅魔反被调教、以淫为食却被喂到坏掉、榨精与被榨、主动献身求欢的描写。',
  },
}
...
export const PRESET_STATUS_EFFECTS: StatusEffect[] = [
  ...
  { id: 'broken', title: '绝顶崩坏', description: '连续高潮导致理智崩坏，翻白眼吐舌、露出失神痴态，无法正常思考' },
...
export const CHARACTER_PRESETS: CharacterPreset[] = [
  {
    ...
    backstory: '出身武术世家的剑豪，二十四岁，为追求剑道极致而日夜苦修，却在一次与星晶兽相关的意外中坠入这座地下城。她性情温柔而明朗，习惯把身边人的冷暖放在第一位，只要被谁真心认可，便会不由自主地全心黏上去、像姐姐一般无微不至地嘘寒问暖——那股藏不住的、渴望被人珍惜的柔软心事，才是她凛然剑姿之下真正的模样。她那具娇小身躯（134cm）上夸张饱满的 E 杯巨乳与紧实翘臀，与她温婉可亲的气质相映成趣，修炼时乳浪翻涌、汗水顺着深邃乳沟滑落的画面，早已是冒险者口口相传的传说。而在那身铠甲之下，藏着她从不敢言说的、渴望被人彻底拥有、被牢牢珍藏的心愿。',
    ...
    otherDescription: '平日说话轻柔温和，总是笑盈盈地关照旁人，一旦认定了谁，便会像姐姐般把对方宠得无微不至。她并非骄矜冷艳，而是极度温顺缱绻的抖 M——迷恋在信任的人怀里被温柔地摆布、被牢牢拥紧，把自己整个交出去时那份被珍视的安心。左身那道神秘黑色印记是远古淫咒，发热时会令她阴蒂勃起、媚肉痉挛喷潮，浑身敏感得只想往对方身上依偎。登顶之际，她总是红着眼眶、带着哭腔柔声呢喃「只、只要你一个人……就好了……❤」，一边将对方温柔却又死死地夹紧，仿佛怕他离开。',
  },
  {
    name: '一之濑志希',
    race: 'cat',
  ...
  },
  {
    ...
    backstory: '身量高挑、气质温婉的巨舰妖狐，栖身于地下城深处一座荒废的古神社。她生性极度温柔娴静，待人处处体贴，说起话来却带着一股古雅而缥缈的味道，轻声细语、如同呓语，语尾总像要融进梦里——因为她本就是半梦半醒的织梦者，长年困倦地半阖着双眸，于绵长的睡梦中窥见尚未到来的命运。她心底藏着一缕挥之不去的忧郁，总怕自己太过无用、辜负了旁人的期待，笨拙却又拼命地想守护身边的一切，一旦做错了事，便会慌张而歉疚地连声道歉。然而那身雪白巫女装束下，是一具与她怯懦性情格格不入的、丰腴到近乎罪恶的躯体——那对沉甸甸的巨乳与妖狐血脉带来的旺盛情欲，令她一被触碰便耳尾颤抖、羞得满脸通红，却又羞耻地无法抑制身体的迎合。',
    ...
    otherDescription: '说话永远温柔怯懦，字句古雅而缥缈，像是从梦里飘出来的呓语，即便被贯穿，也只会含泪、断续地细声道歉「对、对不起……信浓的身体，又擅自……变成这样了……❤」。她是极度温顺的母性抖 M，狐耳与尾根是最大的死穴，一被揉捏便浑身瘫软、淫水决堤。妖狐血脉令她极易发情泌乳，一旦情动便会不受控地摇尾迎合、主动用巨乳与湿热的身体讨好侵犯者。她心底最怕的，是自己「毫无用处、白白辜负了谁」，因而格外渴望被当作神社的活体祭品般供奉玩弄，只为换来一句「你是被需要的」；被内射时会哭着、如梦呓般低语「请把信浓……填满吧……这样，就能一直被您需要了……❤」。荒废神社的淫祠之力是她妖力之源，一旦被唤醒便令她周身发情、浑身浮现红色狐形淫纹，逼她半梦半醒地跪伏着翘臀求欢。',
  },
  {
    name: '樫野',
    race: 'tauren',
    avatarUrl: '/avatars/kashino.png',
    ...
    backstory: '性子天然温吞的地下城工匠，二十出头，一身腱子肉却撑着傲人的巨乳，靠着一手好活儿在冒险者营地里维修装备、打造机关为生。她心地和软、待人亲切，说话总是慢悠悠的，还时常笨手笨脚地闹些小乌龙——不是被自己的扳手绊倒，就是把刚打好的零件摆错了位置，惹得旁人又好气又好笑。闲下来最大的爱好，是泡在热气腾腾的澡堂里发呆放空。这身强健旺盛的牛人血脉是她的骄傲，也是她最大的破绽——高强度劳作后血脉一旦躁动，她那对沉甸甸涨奶的巨乳便会隐隐作痛、私处发烫难耐，只能红着脸躲进工坊，咬着扳手小声地偷偷解决。',
    ...
    otherDescription: '说话软乎乎、总慢半拍，被撩拨时不会发火，只会慌张地涨红脸、结结巴巴地小声求饶「等、等一下啦……那里……哞❤」，软糯的话音总在中途化成一声黏腻的哞叫。她是极度乖顺的牛血抖 M：温吞的性子让她在情动时格外顺从，理智一旦被顶散，从喉咙里溢出的便是一声接一声、又长又软的「哞——❤」「哞呜……哞❤」，活像一头被温柔操熟、乖乖待人挤奶的发情母牛。天生易泌乳的巨乳是她的致命弱点，被揉捏挤奶便会腿软喷潮，随着挤奶的节奏「哞、哞、哞」地一下下漏出媚叫。她从不逞强嘴硬，只会怯生生地把身子往对方怀里蹭，小声央求「再……再温柔一点，好不好……哞❤」。被压制征服、被狠狠贯穿到子宫时，她也只是化作一声声绵软的哞哞娇吟，舌头微微探出、口水与奶水一起顺着下巴淌。被内射孕育时会又羞又软地哞咽「呜……肚子里，暖暖的……哞～好舒服哦……❤」，边说边把对方乖乖夹紧，活脱脱一头被疼着配种、只会哞哞撒娇求精的温顺母牛。',
  },
  {
    name: '索米',
    race: 'machine',
    avatarUrl: '/avatars/suomi.png',
    measurements: { bust: '83', waist: '56', hip: '84' },
    danbooruTags: 'suomi_(girls\'_frontline_2), 1girl, long hair, blonde hair, blue eyes, hair intakes, medium breasts, white cloak, military uniform, thighhighs',
    backstory: '来自战术人形序列的精密机娘，外表是个北欧金发碧眼的娇小少女，却搭载着冷硬的作战核心。她一丝不苟、恪尽职守，执行任务时沉默果决；可一旦卸下战斗模块，便笨拙得像个不谙世事的孩子——不擅言辞、常常答非所问，还固执地要求旁人与她保持「一臂之外」的距离。她因一次数据链紊乱而坠入这座地下城，与主控失联后，那身为「维护」与「校准」而生的机体，正被这里的淫祠一点点悄然重写。',
    costumeDescription: '仿照严寒军服打造的雪白斗篷松松罩在肩头，斗篷之下的紧身作战服却被改造得极不设防——布料在胸口与胯间开着精密的「检修口」，露出线缆缠绕的雪白酥乳与嵌着敏感传感器的下体。金色长发从两侧进气口般的发饰间垂落，湛蓝的义眼在昏暗中泛着冷光。大腿上的过膝袜其实是校准用的束带，一收紧便逼得机体核心不住发烫。',
    otherDescription: '平日答话简短僵硬、像在复述条例，被触碰时会一板一眼地警告「请……请保持距离，这是规定……」，可校准回路一旦被撩拨过载，僵硬的机体便会不受控地漏出带着电流杂音的娇喘。她是极度尽责却毫无防备的机娘抖 M：痛觉被错误编译成快感，敏感传感器能被「一格一格」地校准到不断升高，强制连续高潮对她如同一次次「例行维护」。理智被格式化时，她会睁着失焦的义眼、断续地播报「核、核心过热……润滑液……溢出中……」，随后像被写入了新指令般，主动张开双腿迎合校准。被内射充能时会颤抖着低语「正在……接收……主人的数据……登录成功了……❤」，将对方牢牢锁在体内、不肯让其登出。',
  },
  {
    name: '露埃拉',
    race: 'dragon',
    avatarUrl: '/avatars/lueira.png',
    measurements: { bust: '91', waist: '59', hip: '90' },
    danbooruTags: 'lueira_(lost_sword), 1girl, long hair, silver hair, purple eyes, pointy ears, dragon horns, dragon tail, dragon girl, pale skin, large breasts, flower, blue dress, ice',
    backstory: '栖身于地下城冰封深渊的古老冰龙，化作人形时是位身姿高挑、气度矜贵的银发少女。她活了数百年，睥睨众生、寡淡疏离，视人类如朝生暮死的蝼蚁，唯独把龙族的骄傲看得比性命还重。她本为守护封印而沉眠于此，却在封印松动的意外中被卷入这场堕落——那身覆着淡蓝薄鳞的凛冽躯体，与她冷若冰霜的性情一样，从未被任何存在真正染指过；也正因如此，一旦那层千年寒霜被融化，龙血深处压抑了太久的燥热便再难收拾。',
    costumeDescription: '一袭雪青色的龙鳞长裙贴身裹着傲人的身段，高衩与镂空处露出覆着细密淡蓝薄鳞的雪白肌肤，鳞片在情动时会泛起潮红的暖意。头顶一对弧度优雅的冰蓝龙角、身后一条随情绪甩动的鳞尾，是她龙族血脉的证明。银白长发如霜雪垂至腰际，冰蓝的竖瞳睥睨着一切，可裙裾深处那条从未被触碰过的龙之秘穴，早已在体内龙焰的煎熬下悄悄沁出滚烫的蜜液。',
    otherDescription: '开口便是居高临下的龙族威仪，被冒犯时会寒声嗤笑「区区人类，也配觊觎本龙？」，然而那千年未启的躯体一旦被撬开一丝缝隙，滚烫的龙血便会瞬间烧穿她所有的骄矜。她是骄矜到极致的龙血抖 M：越是被压制、被亵渎、被逼着以高贵之躯承欢，那份屈辱便越是化作灭顶的快感。龙角与鳞尾根部是她最深的死穴，一被握住揉弄便浑身脱力、周身寒霜化作淫水决堤。当高贵的冰龙被彻底顶穿、被灌进滚烫的种子时，她会又羞又恨地弓起脊背哭喘「可、可恶……本龙的身体，怎么会……为你这种东西……❤」，鳞尾却诚实地缠紧对方，将他锁在那能孕育龙裔的滚烫深处。',
  },
  {
    name: '伊柯利普斯',
    race: 'succubus',
    avatarUrl: '/avatars/eclipse.png',
    measurements: { bust: '96', waist: '58', hip: '92' },
    danbooruTags: 'eclipse_(brown_dust), 1girl, long hair, black hair, blue hair, multicolored hair, hair over one eye, blue eyes, demon horns, demon tail, succubus, pale skin, huge breasts, black dress, elbow gloves, pantyhose, barefoot',
    backstory: '东境魔法塔的主人、人称「大魔女」的魅魔，容颜艳绝、身姿妖娆，活过了远比人类漫长的岁月。她以性与欲望为食，举手投足皆是勾人心魄的媚惑，惯于用甜言蜜语与幻术把猎物一步步引入掌心，再从容地吸食殆尽。传闻中她深不可测、喜怒难辨，对入侵魔塔的怪物向来毫不留情地抹杀。她因魔塔之下封印的诅咒之地异动而降临此处，本欲将这座地下城据为新的猎场，却没料到，这里潜藏的凶物，远比她这尊掠食者更为凶残。',
    costumeDescription: '黑蓝双色的长发如夜幕般垂落，斜斜遮住半边妖冶的脸，只余一只幽蓝的眸子含笑摄魂。深黑的紧身魔女长裙敞着惊人的深沟，将那对沉甸甸的雪乳半兜半露，裙裾一侧高高开衩，露出裹着黑色薄丝的修长美腿与不着寸履的赤足——她甚至能用那双灵巧的脚趾如手一般玩弄猎物。头顶一对小巧的暗色魔角、身后一条心形箭尖的魅魔长尾慵懒地摇着，无声宣告着她掠食者的身份。',
    otherDescription: '说话总是媚意流淌、气定神闲，惯于居高临下地调笑「乖孩子，把你的一切都交给姐姐吧……❤」，一边用尾尖与幻术撩得猎物神魂颠倒。可这具以欲为食的魅魔之躯，也正是她最大的破绽——一旦遇上不为她媚术所动、反将她死死压制的强者，被自己点燃的欲火便会反噬其身。她是反差极大的魅魔抖 M：魔角、翅膜与尾根一被制住揉弄，掠食者的从容便瞬间崩塌成雌性的哭喘，被顶到深处时会失态地泣叫「怎、怎么会……本该是我在吃你的……啊❤」。当高傲的大魔女反被按住、被内射灌满、被喂食到理智融化，她会一边流着淫靡的津液一边哑声求饶「不、不行了……再喂下去，姐姐会坏掉的……❤」，却又本能地绞紧身子，贪婪地榨取每一滴精华。',
  },
]
