...
(function (D) {
  ...
  function open() {
    ...
    root.querySelector('#set-save').addEventListener('click', function () {
      var next = {
        chatModel: document.getElementById('set-model').value,
        proseStyle: document.getElementById('set-prose').value,
        imageStyle: document.getElementById('set-style').value,
        imageTagPreset: document.getElementById('set-preset').value,
        imageStyleCustom: document.getElementById('set-custom').value.trim(),
      };
